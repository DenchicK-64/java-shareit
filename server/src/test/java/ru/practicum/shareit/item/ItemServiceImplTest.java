...
public class ItemServiceImplTest {
    ...
    public void setUp() {
        ...
        commentOne = new Comment(1L, "some text", testItem, testUserTwo,
                LocalDateTime.now());
        itemRequest = new ItemRequest(1L, "Test_Description", testUserTwo, LocalDateTime.now());
        lastBooking = new Booking(1L, LocalDateTime.now().minusMinutes(20),
                LocalDateTime.now().plusMinutes(20), testItem, testUserTwo, Status.WAITING);
        nextBooking = new Booking(2L, LocalDateTime.now().plusDays(8),
    ...
    public void createComment_whenDataIsCorrect_thenAddComment() {
        ...
        when(bookingRepository.findFirstByBookerAndItemAndEndIsBeforeOrderByEndDesc(any(), any(), any(LocalDateTime.class)))
        ...
        verify(bookingRepository, times(1))
                .findFirstByBookerAndItemAndEndIsBeforeOrderByEndDesc(any(), any(), any(LocalDateTime.class));
