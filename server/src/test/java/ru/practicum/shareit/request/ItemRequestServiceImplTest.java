...
public class ItemRequestServiceImplTest {
    ...
    public void setUp() {
        ...
        /*now = LocalDateTime.of(
                ...
                10,
                10);*/
        itemRequestOne = new ItemRequest(1L, "Test_Description", testUserTwo, LocalDateTime.now());
        itemRequestTwo = new ItemRequest(2L, "Test_Description", testUser, LocalDateTime.now().plusDays(2));
