...
public class BookingControllerTest {
    ...
    public void setUp() {
        ...
        testBookingRequestDto = new BookingRequestDto(1L, 1L, now.plusDays(10), now.plusDays(11), null);
        ...
        testBookingRequestDtoTwo = new BookingRequestDto(2L, 2L, now.plusDays(12), now.plusDays(14), null);
    ...
    public void create_whenInvokedWithoutXSharerHeader_thenReturnStatusBadRequest() throws Exception {
        BookingRequestDto bookingRequestDtoNotValid = new BookingRequestDto(1L, 1L,
                now.plusDays(15), now.plusDays(16), null);
        mvc.perform(post("/bookings")
