...
public class ItemRequestControllerTest {
    ...
    public void setUp() {
        ...
        testItemRequestDto = new ItemRequestDto(1L, "Test_Description", testUserDto, now.minusDays(5));
        testItemRequestDtoWithItems = new ItemRequestDtoWithItems(2L, "Test_Description_2",
                testUserTwoDto, now.minusDays(3), new ArrayList<>());
        testItemRequestDtoWithItemsTwo = new ItemRequestDtoWithItems(3L, "Test_Description_3",
                testUserDto, now.minusDays(2), new ArrayList<>());
    }
    ...
    public void create_whenInvokedWithEmptyDescription_thenReturnStatusBadRequest() throws Exception {
        ItemRequestDto testItemRequestDto = new ItemRequestDto(5L, "", testUserDto, now.minusDays(4));
