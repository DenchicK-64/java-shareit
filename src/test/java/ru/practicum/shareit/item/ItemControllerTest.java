...
public class ItemControllerTest {
    ...
    public void setUp() {
        ...
        commentOne = new CommentDto(1L, "some text", 3L, "author1", now);
    ...
    public void create_whenInvokedWithEmptyName_thenReturnStatusBadRequest() throws Exception {
        ItemDto itemDtoNotValid = new ItemDto(5L, "", "some_description", true, 3L);

        mvc.perform(post("/items")
                        .header("X-Sharer-User-Id", "1")
                        .content(mapper.writeValueAsString(itemDtoNotValid))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andDo(print())
    ...
    @Test
    public void create_whenInvokedWithEmptyDescription_thenReturnStatusBadRequest() throws Exception {
        ItemDto itemDtoNotValid = new ItemDto(5L, "Text", "", true, 3L);
    ...
    @Test
    public void create_whenInvokedWithoutAvailable_thenReturnStatusBadRequest() throws Exception {
        ItemDto itemDtoNotValid = new ItemDto(5L, "Text", "text", null, 3L);
    ...
    @Test
    public void createComment_whenInvokedWithEmptyText_thenReturnStatusOk() throws Exception {
        CommentDto comment = new CommentDto(1L, "", 3L, "author1", LocalDateTime.of(2023, 7, 8, 10, 0, 0));
        when(itemService.createComment(1L, 3L, comment))
                .thenReturn(comment);
